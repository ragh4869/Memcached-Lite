...
# Defining multi-client connection
def multi_client_conn(conn):
    conn.sendall('Server is connected'.encode())
...
def server_program():
    ...
    while True:
        ...
        start_new_thread(multi_client_conn, (conn,))
